...
var app = new Vue({
  ...
  methods: {
    deleteResource: function deleteResource(id) {
      var form = document.getElementById("deleteForm_".concat(id));
      sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire({
        title: '¿Está seguro?',
        text: 'Ester registro será eliminado',
        icon: 'question',
        confirmButtonText: 'Aceptar',
        showCancelButton: true
      }).then(function (result) {
        if (result.isConfirmed) {
          sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire('¡Eliminado!', 'Eliminado satisfactoriamente', 'success');
          form.submit();
        }
      });
    },
    filterByCity: function filterByCity() {
      document.getElementById('filterByCityForm').submit();
    }
  }
});
...
__webpack_require__(/*! D:\user\escritorio\Proyectos\serempe-test\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\user\escritorio\Proyectos\serempe-test\resources\sass\app.scss */"./resources/sass/app.scss");
